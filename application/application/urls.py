...
urlpatterns = [
    ...
    path('inventory_information/', inventory_information, name='inventory_information'),
    path('inventory_information_dashboard/', inventory_information_dashboard, name='inventory_information_dashboard'),
